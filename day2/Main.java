...
//        System.out.println("==============================================");
 ...
 //       List<Product> prods = service.getProductWithText("black");
  //      for(Product product : prods){
   ...
   //   System.out.println("==============================================");
    //  System.out.println("a products with particular place");

    //  List<Product> products = service.getProductByPlace("Black Table");
    //  for(Product p : products){
    //    System.out.println(p);
   // }

    // System.out.println("==============================================");
    // System.out.println("a products out of warranty");

    //   List<Product> products = service.getProductsWithOutOfWarranty();
    //   for(Product p : products){
    //     System.out.println(p);
    // }

    System.out.println("==============================================");
    System.out.println("a products in warranty");

      List<Product> products = service.getProductswithInWarranty();
      for(Product p : products){
        System.out.println(p);
    }
